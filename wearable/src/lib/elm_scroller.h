...
/**
 * @brief Set mouse wheel event on a scroller
 *
 * @param obj The scroller object
 * @param disabled If wheel event is disabled or not
 *
 * This enables or disables mouse wheel event for scroller.
...
/**
 * @brief Get mouse wheel event for a scroller
 *
 * @param obj The scroller object
 *
 * This gets if wheel event is disabled or not.
 *
