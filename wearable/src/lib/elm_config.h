...
/**
 * Get whether the reading the password on accessibiliy is enabled.
 *
 * @return if the reading the password on accessibility is enabled.
 *
 * @since 1.8
 *
 * @ingroup Access
...
/**
 * Set whether the reading the password on accessibiliy is enabled.
 *
 * @param enabled If EINA_TRUE enables the reading password on accessibility
 *
 * @since 1.8
 *
 * @ingroup Access
