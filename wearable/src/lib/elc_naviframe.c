...
_item_del_pre_hook(Elm_Object_Item *it)
{
   ...
   if (!sd->on_deletion)
     {
        _elm_access_highlight_read_enable_set(VIEW(nit), EINA_FALSE);
                       ...
                       const char *source __UNUSED__)
{
   ...
   _elm_access_highlight_read_enable_set(VIEW(it), EINA_TRUE);
                                ...
                                Evas_Object **next)
{
   ...
   if (!_elm_config->access_mode) goto end;
   ...
   if (prev_it)
     {
        ...
        _elm_access_highlight_read_enable_set(VIEW(prev_it), EINA_FALSE);
...
elm_naviframe_item_pop(Evas_Object *obj)
{
   ...
   _elm_access_highlight_read_enable_set(VIEW(it), EINA_FALSE);
