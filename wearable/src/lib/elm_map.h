...
/**
 * Get the names of available engines.
 *
 * @param obj The map object.
 * @return The char pointer array of engine names.
 *
 * It will provide a list with all available map engines.
 * Current engine can be set by elm_map_engine_set(), or get with
 * elm_map_engine_get().
 *
 * Defaultly tile engine is implemented.
 *
...
/**
 * Set the current engine of the map.
 *
 * @param obj The map object.
 * @param engine_name The engine to be used.
 *
 * The @p engine_name need to match one of the names provided by
 * elm_map_engines_get().
 *
 * The current engine can be get using elm_map_engine_get().
 *
 * Defaultly tile engine is used.
 *
 * @see elm_map_engines_get()
 * @see elm_map_engine_get()
 * @return @c EINA_TRUE if success. @c EINA_FALSE if failure.
 *
 * @ingroup Map
 */
...
/**
 * Get the name of currently used engine.
 *
 * @param obj The map object.
 * @return Returns the name of the engine in use.
 *
 * @see elm_map_engines_get()
 * @see elm_map_engine_set()
 *
...
/**
* Get an offscreen rendered image of the map. The coordinates, zoom level etc must already be set prior to
* calling this function
*
* @param obj The map object
* @param w   The width of the output image
* @param h   The height of the output image
* @param map_image_cb The callback function that will be called when the map image is ready
* @param data The user callback data
