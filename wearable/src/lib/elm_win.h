 ...
 *
 * @return The type of a window object. If the object is not window object, return -1.
 *
 * @ingroup Win
 */
...
/**
 * Set the manual rotation done mode of the window
 *
 * @param obj The window object
 * @param set If true, the window manager will not rotate the window until
...
/**
 * Get the manual rotation done mode of the window
 *
 * @param obj The window object
...
/**
 * Set Desktop Layout Support State.
 *
 * @param obj The window object
 * @param support If true, the window manager will provide desktop layout mode
 * If false window manager set window to normal mode.
 * @ingroup Win
 * @since 1.8
 */
...
/**
 * @brief Create an auxiliary hint of the window.
 *
 * @param obj The window object
...
/**
 * @brief Delete an auxiliary hint of the window.
 *
 * @param obj The window object
