          ...
          if (sd->horizontal && (sd->item_height > 0))
            {
               ...
               if (row <= 0) row = 1;
               x = it->position / row;
               if (x == 0) y = it->position;
               else if (x > 0) y = it->position % x;
               if (x >= 1)
          ...
          else if (sd->item_width > 0)
            {
               ...
               if (y == 0) x = it->position;
               else if (y > 0) x = it->position % y;
                    ...
                    void *event_info)
{
   ...
   it->item->highlight_timer = ecore_timer_add(ITEM_HIGHLIGHT_TIMER,
                                               _highlight_timer, it);
