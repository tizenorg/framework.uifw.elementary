                     ...
                     int level)
{
   ...
   edje_object_part_geometry_get(ELM_WIDGET_DATA(sd)->resize_obj, "clip", NULL, NULL, NULL, &ih);
...
elm_index_item_clear(Evas_Object *obj)
{
   ...
   elm_layout_content_unset(obj, "elm.swallow.event.0");
   if (sd->event[1])
     elm_layout_content_unset(obj, "elm.swallow.event.1");
}
