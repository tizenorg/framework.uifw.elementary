...
field_create(Elm_Datetime_Module_Data *module_data, Elm_Datetime_Field_Type  field_type)
{
   ...
   if (field_type == ELM_DATETIME_AMPM)
   ...
   else
     {
       ...
       Elm_Spinner_Data *sd = eo_data_scope_get(field_obj, ELM_SPINNER_CLASS);
       if (field_type == ELM_DATETIME_HOUR)
          {
           elm_atspi_accessible_name_set(sd->inc_button, N_("IDS_COM_BODY_INCREASE_HOUR_ACCESS"));
           elm_atspi_accessible_name_set(sd->dec_button, N_("IDS_COM_BODY_DECREASE_HOUR_ACCESS"));
          }
       else if (field_type == ELM_DATETIME_MINUTE)
          {
           elm_atspi_accessible_name_set(sd->inc_button, N_("IDS_COM_BODY_INCREASE_MINUTE_ACCESS"));
           elm_atspi_accessible_name_set(sd->dec_button, N_("IDS_COM_BODY_DECREASE_MINUTE_ACCESS"));
          }
       else if (field_type == ELM_DATETIME_DATE)
          {
           elm_atspi_accessible_name_set(sd->inc_button, N_("IDS_COM_BODY_DECREASE_DAY"));
           elm_atspi_accessible_name_set(sd->dec_button, N_("IDS_COM_BODY_INCREASE_DAY"));
          }
       else if (field_type == ELM_DATETIME_MONTH)
          {
           elm_atspi_accessible_name_set(sd->inc_button, N_("IDS_COM_BODY_INCREASE_MONTH"));
           elm_atspi_accessible_name_set(sd->dec_button, N_("IDS_COM_BODY_DECREASE_MONTH"));
          }
       else if (field_type == ELM_DATETIME_YEAR)
          {
           elm_atspi_accessible_name_set(sd->inc_button, N_("IDS_COM_BODY_INCREASE_YEAR"));
           elm_atspi_accessible_name_set(sd->dec_button, N_("IDS_COM_BODY_DECREASE_YEAR"));
          }
       else
          {
           elm_atspi_accessible_name_set(sd->inc_button, N_("IDS_COM_BODY_INCREASE"));
           elm_atspi_accessible_name_set(sd->dec_button, N_("IDS_COM_BODY_DECREASE"));
          }
       elm_atspi_accessible_translation_domain_set(sd->inc_button, PACKAGE);
       elm_atspi_accessible_translation_domain_set(sd->dec_button, PACKAGE);
     }
