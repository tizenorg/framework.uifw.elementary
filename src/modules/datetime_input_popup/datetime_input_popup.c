...
_create_datetime_popup(Popup_Module_Data *popup_mod)
{
   ...
   elm_object_domain_translatable_text_set(cancel_btn, PACKAGE, N_("Cancel"));
   ...
   elm_object_domain_translatable_text_set(set_btn, PACKAGE, N_("Set"));
...
static void
_custom_picker_layout_create_cb(void *data, Evas_Object *obj __UNUSED__, void *event_info)
{
   Popup_Module_Data *popup_mod;
...
elm_modapi_init(void *m __UNUSED__)
{
   ...
   tmp = E_("IDS_COM_BODY_DECREASE_DAY");
   tmp = E_("IDS_COM_BODY_DECREASE_HOUR");
   tmp = E_("IDS_COM_BODY_DECREASE_MINUTE");
   tmp = E_("IDS_COM_BODY_DECREASE_MONTH");
   tmp = E_("IDS_COM_BODY_DECREASE_YEAR");
   tmp = E_("IDS_COM_BODY_INCREASE_DAY");
   tmp = E_("IDS_COM_BODY_INCREASE_HOUR");
   tmp = E_("IDS_COM_BODY_INCREASE_MINUTE");
   tmp = E_("IDS_COM_BODY_INCREASE_MONTH");
   tmp = E_("IDS_COM_BODY_INCREASE_YEAR");
   tmp = E_("IDS_IDLE_BODY_TAP_TO_CHANGE");
