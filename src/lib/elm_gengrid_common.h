...
/**
 * @brief Add a new gengrid item class in a given gengrid widget.
 *
 ...
 *
 * @remark This adds gengrid item class for the gengrid widget. When adding an item,
...
/**
 * @brief Remove an item class in a given gengrid widget.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This removes item class from the gengrid widget.
 ...
 *
 * @remark This API just increases its reference count for item class management.
 *
 * @see elm_gengrid_item_class_unref()
 *
 * @ingroup Gengrid
 ...
 * @param[in] itc The given item class object to reference
 *
 * @remark This API just decreases its reference count for item class management.
...
/**
 * @brief Set the text to be shown in a given gengrid item's tooltips.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This call will setup the text to be used as tooltip to that item
 ...
 * will get removed.
 *
 * @remark In order to set a content or something else as a tooltip, look at
...
/**
 * @brief Set the content to be shown in a given gengrid item's tooltip
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This call will setup the tooltip's contents to @p item
 ...
 *
 * @remark In order to set just a text as a tooltip, look at
...
/**
 * @brief Unset a tooltip from a given gengrid item
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] it gengrid item to remove a previously set tooltip from.
 *
 * @remark This call removes any tooltip set on @p item. The callback
...
/**
 * @brief Set a different @b style for a given gengrid item's tooltip.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] it gengrid item with tooltip set
 * @param[in] style the <b>theme style</b> to use on tooltips (e.g. @c
 * "default", @c "transparent", etc)
 *
 * @remark Tooltips can have <b>alternate styles</b> to be displayed on,
 ...
 *
 * @remark before you set a style you should define a tooltip with
...
/**
 * @brief Get the style set a given gengrid item's tooltip.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] it gengrid item with tooltip already set on.
 ...
 *
 * @remark This function allows a tooltip to expand beyond its parent window's canvas.
 ...
 *
 * @remark This function returns whether a tooltip is allowed to expand beyond
 ...
 * @endif
 *
 * @param[in] it gengrid item to customize cursor on
 * @param[in] cursor the cursor type's name
 *
 * @remark This function works analogously as elm_object_cursor_set(), but
 ...
 *
 * @remark If this function is called twice for an object, a previously set
 ...
 * @endif
 *
 * @param[in] it gengrid item with custom cursor set
...
/**
 * @brief Unset any custom mouse pointer/cursor decoration set to be
 ...
 * @endif
 *
 * @param[in] it a gengrid item
 *
 * @remark Use this call to undo any custom settings on this item's cursor
 ...
 * @c "transparent", etc)
 *
 * @remark This function only makes sense when one is using custom mouse
...
/**
 * @brief Get the current @b style set for a given gengrid item's custom
 * cursor
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
...
/**
 * @brief Set if the (custom) cursor for a given gengrid item should be
 ...
 * @endif
 *
 * @param[in] it item with custom (custom) cursor already set on
 * @param[in] engine_only Use @c EINA_TRUE to have cursors looked for
 * only on those provided by the rendering engine, @c EINA_FALSE to
 * have them searched on the widget's theme, as well.
 *
 * @remark This call is of use only if you've set a custom cursor
 * for gengrid items, with elm_gengrid_item_cursor_set().
 *
 * @remark By default, cursors will only be looked for between those
...
/**
 * @brief Get if the (custom) cursor for a given gengrid item is being
