...
/////////////////////////////////////////////////////////////////
#define TIZEN_DUMMY_API_LOG \
   ERR("TIZEN_ONLY: This API is not implemented.")

// Put the dummy enum here.
typedef enum
{
...
// genlist
EAPI void         elm_genlist_item_reorder_start(Elm_Object_Item *item);
EAPI void         elm_genlist_item_reorder_stop(Elm_Object_Item *item);
// main
