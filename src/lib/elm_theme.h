...
/**
 * @brief Create a new specific theme
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @remark This creates an empty specific theme that only uses the default theme. A
 ...
 *
 * @remark This frees a theme created with elm_theme_new().
 *
 * @ingroup Theme
 */
...
/**
 * @brief Copy the theme from the source to the destination theme
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This makes a one-time static copy of all the theme config, extensions
...
/**
 * @brief Tell the source theme to reference the ref theme
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] th The theme that will do the referencing
 * @param[out] thref The theme that is the reference source
 *
 * @remark This clears @p th to be empty and then sets it to refer to @p thref
...
/**
 * @brief Return the theme referred to
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This gets the theme set as the reference theme by elm_theme_ref_set().
 ...
 *
 * @remark This returns the internal default theme setup handle that all widgets
 ...
 * @endif
 *
 * @param[in] th The theme to add to, or if NULL, the default theme
 * @param[in] item The Edje file path to be used
 *
 * @remark Use this if your application needs to provide some custom overlay theme
 ...
 * @endif
 *
 * @param[in] th The theme to delete from, or if NULL, the default theme
...
/**
 * @brief Get the list of registered overlays for the given theme
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 * @param[in] item The Edje file path to be used
 *
 * @remark This is intended when an application needs more styles of widgets or new
...
/**
 * @brief Get the list of registered extensions for the given theme
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
...
/**
 * @brief Set the theme search order for the given theme
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] th The theme to set the search order, or if NULL, the default theme
 * @param[in] theme Theme search string
 *
 * @remark This sets the search string for the theme in path-notation from first
 * theme to search, to last, delimited by the : character. Example:
 *
 * "shiny:/path/to/file.edj:default"
 *
 * @remark See the ELM_THEME environment variable for more information.
 *
 * @see elm_theme_get()
...
/**
 * @brief Return the theme search order
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] th The theme to get the search order, or if NULL, the default theme
...
/**
 * @brief Return a list of theme elements to be used in a theme.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] th Theme to get the list of theme elements from.
 * @return The internal list of theme elements
 *
 * @remark This returns the internal list of theme elements (will only be valid as
 ...
 *
 * @remark A theme element can consist of a full or relative path to a .edj file,
...
/**
 * @brief Return the full path for a theme element
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 * @param[out] in_search_path Pointer to a boolean to indicate if item is in the search path or not
 * @return The full path to the file found.
 *
 * @remark This returns a string you should free with free() on success, NULL on
...
/**
 * @brief Flush the current theme.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] th Theme to flush
 *
 * @remark This flushes caches that let elementary know where to find theme elements
...
/**
 * @brief This flushes all themes (default and specific ones).
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @remark This will flush all themes in the current application context, by calling
...
/**
 * @brief Return a list of theme elements in the theme search path
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This lists all available theme files in the standard Elementary search path
...
/**
 * @brief Free the list returned by elm_theme_name_available_list_new()
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @remark This frees the list of themes returned by
...
/**
 * @brief Set a specific theme to be used for this object and its children
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This sets a specific theme that will be used for the given object and any
 ...
 *
 * @remark Use special themes with great care as this will annoy users and make
...
/**
 * @brief Get the specific theme to be used
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 ...
 *
 * @remark This will return a specific theme set, or NULL if no specific theme is
...
/**
 * @brief Get a data item from a theme
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] th The theme, or NULL for default theme
 * @param[in] key The data key to search with
 * @return The data value, or NULL on failure
 *
 * @remark This function is used to return data items from edc in @p th, an overlay, or an extension.
