...
struct _Elm_Naviframe_Item
{
   ...
   Elm_Transit *tizen_transit;     //Tizen Only for zoom effect.

#ifdef ELM_FEATURE_WEARABLE
   Elm_Transit *tizen_transit2;    //Tizen Only for zoom effect.
#endif

   Eina_Bool    title_enabled : 1;
   Eina_Bool    popping : 1;
   Eina_Bool    delete_me : 1;
   Eina_Bool    tizen_zoom : 1;    //Tizen Only for zoom effect.
   int          ref;
};
...
{
   void (*tizen_push_effect)(Elm_Naviframe_Item *it);
   void (*tizen_pop_effect)(Elm_Naviframe_Item *it);
};
