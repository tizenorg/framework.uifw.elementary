...
// Tizen Only (20150619) : elm_web is not used in Tizen 2.4
...
void                 _elm_atspi_bridge_connected_cb_set(void (*cb)(void));
/* end of DEPRECATED */
...
// TIZEN_ONLY(20150529): Make _elm_config to be visible to elementary modules.
//extern Elm_Config *_elm_config;
EAPI extern Elm_Config *_elm_config;
//
