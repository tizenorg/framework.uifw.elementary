...
#if 0 //During Reordering Mode, why group items need XX_recalc while _item_position doing the job.
...
#if 1 // During pan smart calculation, grp items recalc required. Same as svn code.
