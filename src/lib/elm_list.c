...
static void _item_highlight(Elm_List_Item_Data *it);
static void _item_select(Elm_List_Item_Data *it);
static void _item_unhighlight(Elm_List_Item_Data *it);
static void _item_unselect(Elm_List_Item_Data *it);
//
...
EOLIAN static Eina_Bool
_elm_list_item_elm_interface_atspi_component_highlight_clear(Eo *eo_it EINA_UNUSED, Elm_List_Item_Data *it)
{
