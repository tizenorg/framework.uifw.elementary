 ...
 * @endif
 *
 * @param[in] parent Parent object to add the window to, or NULL
 * @param[in] name The name of the window
 * @param[in] type The window type, one of #Elm_Win_Type.
 *
 ...
 * @brief Creates a fake window object using a pre-existing canvas.
 *
 ...
 * @internal
 *
 * Creates a tizen_widget window object using a parent's canvas.
 * @brief Creates a tizen_widget window object using a parent's canvas.
 *
 * @param parent The parent object
 * @param name The name of the window
 *
 * This creates a window using canvas of @p parent.
 * The returned window widget will modify the canvas
 * this canvas must continue to be managed externally.
 *
 * @return The created object, or @c NULL on failure
 *
 ...
 * @since_tizen 2.4
 */
EAPI Evas_Object          *elm_win_tizen_widget_add(const char * name, Evas_Object *parent);
 ...
 * @param[in] floating If true, the window is floating mode
 *
