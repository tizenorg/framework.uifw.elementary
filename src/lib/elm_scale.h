...
/**
 * @brief Set the scaling factor for a given Elementary object
 *
 ...
 * @param[in] scale Scale factor (from @c 0.0 up, with @c 1.0 meaning
 * no scaling)
 *
 * @ingroup Scaling
 */
...
/**
 * @brief Get the scaling factor for a given Elementary object
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
