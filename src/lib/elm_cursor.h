...
/**
 * @brief Set the cursor to be shown when mouse is over the object
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @remark Set the cursor that will be displayed when mouse is over the
 ...
 *
 * @param[in] obj the object being set a cursor.
...
/**
 * @brief Get the cursor to be shown when mouse is over the object
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @param[in] obj an object with cursor already set.
...
/**
 * @brief Unset cursor for object
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
 *
 * @remark Unset cursor for object, and set the cursor to default if the mouse
 ...
 * @endif
 *
 * @remark before you set a style you should define a cursor with
...
/**
 * @brief Get the style for this object cursor.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
...
/**
 * @brief Set if the cursor set should be searched on the theme or should use
 ...
 * @endif
 *
 * @remark before you set theme_search you should define a cursor with
 * elm_object_cursor_set(). By default it will only look for cursors
 * provided by the engine.
 *
 * @param[in] obj an object with cursor already set.
 * @param[in] theme_search boolean to define if cursors should be searched
 * on widget's theme.
 *
 * @ingroup Cursors
 */
...
/**
 * @brief Get if the cursor set should be searched on the theme for this object cursor.
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
