...
_prop_config_get(void)
{
   ...
   // TIZEN_ONLY(20150813) call elm_win_access only when access_mode is changed
...
_config_load(void)
{
   ...
   _elm_config->naviframe_prev_btn_auto_pushed = EINA_FALSE;
// TIZEN_ONLY(20150705): Genlist item align feature
