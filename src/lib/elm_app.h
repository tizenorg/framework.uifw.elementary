...
/**
 * @brief Re-locate the application somewhere else after compilation, if the developer
 ...
 * @param[in] dom This will be used as the application's "domain", in the
 ...
 *
 * @remark The prefix system is designed to locate where the given software is
 ...
 *
 * @remark Call elm_app_info_set() early on before you change working
 * directory or anything about @c argv[0], so it gets accurate
 * information.
 *
 * @remark It will then try and trace back which file @p mainfunc comes from,
 * if provided, to determine the application's prefix directory.
 *
 * @remark The @p dom parameter provides a string prefix to prepend before
 ...
 *
 * @remark The @p dom string also provides a subdirectory inside the system
 ...
 * this directory.
 *
 * @remark The @p checkfile is a file name or path of something inside the
...
/**
 * @brief Provide information on the @b fallback application's binaries
 ...
 * one)
 *
 * @remark Elementary will as well use this path to determine actual
...
/**
 * @brief Provide information on the @b fallback application's libraries
...
/**
 * @brief Provide information on the @b fallback application's data
 * directory, on scenarios where they get overridden by
 * elm_app_info_set().
 *
 * @if MOBILE @since_tizen 2.3
...
/**
 * @brief Provide information on the @b fallback application's locale
 * directory, on scenarios where they get overridden by
 * elm_app_info_set().
 *
 * @if MOBILE @since_tizen 2.3
...
/**
 * @brief Get the application formal name, as set by elm_app_name_set().
 *
 * @if MOBILE @since_tizen 2.3
 * @elseif WEARABLE @since_tizen 2.3.1
 * @endif
...
/**
 * @brief Get the application's run time prefix directory, as set by
...
/**
 * @brief Get the application's run time binaries prefix directory, as
...
/**
 * @brief Get the application's run time libraries prefix directory, as
 * set by elm_app_info_set() and the way (environment) the application
 * was run from.
 *
 * @if MOBILE @since_tizen 2.3
...
/**
 * @brief Get the application's run time data prefix directory, as
 * set by elm_app_info_set() and the way (environment) the application
 * was run from.
 *
 * @if MOBILE @since_tizen 2.3
...
/**
 * @brief Get the application's run time locale prefix directory, as
 * set by elm_app_info_set() and the way (environment) the application
 * was run from.
 *
 * @if MOBILE @since_tizen 2.3
 ...
 * @endif
 *
 * @param[in] base_scale The scale that the application is made on the basis of.
 *
 * @remark The scale is used for the application to be scaled.
 ...
 *
 * @remark You should call this function @b before using ELM_SCALE_SIZE macro.
 *
 * @ingroup App
 * @since 1.12
 */
